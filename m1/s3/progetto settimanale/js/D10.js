...
console.log(deleteOne("Ilovecoding", false));
...
console.log(onlyLetters("9878778 787878789 I have 878989896 dogs 676786786"));
...
console.log(isThisAnEmail("ychagexam@ple.com"));
...
console.log(howManyDays('4/1/2023'));
...
function isTodayMyBirthday(date) {
  ...
  if (today.getMonth() == data.getMonth() && today.getDate() == data.getDate()) {
    return true;
  } else {
    return false;
  }
...
console.log(isTodayMyBirthday('4/14/2002'));
